...
function renderSubsystemPartIcon(type, label) {
  ...
  if (type === "fire") {
    return `<svg class="topology-svg-icon fire-svg-icon" viewBox="0 0 64 64" role="img" aria-label="${label}">${title}<rect x="20" y="15" width="24" height="34" rx="4" fill="rgba(255,255,255,.13)" stroke="currentColor" stroke-width="2"/><path d="M32 42c6-4 7-9 3-15-1 4-4 6-7 8 0-5-2-8-5-11 1 8-5 11-3 17 2 6 9 8 12 1z" fill="currentColor"/><circle cx="40" cy="22" r="2.2" fill="currentColor" opacity=".8"/></svg>`;
  }
