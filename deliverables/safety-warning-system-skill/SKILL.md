...
- Single-subsystem detail/diagnosis pages should hide that selector and show a plain `场站 - 子系统` title in the header. Returning to station-level pages should restore the selector.
