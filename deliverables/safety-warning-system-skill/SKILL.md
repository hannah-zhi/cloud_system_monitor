...
- Add three top indicator cards to `场站概览`: `安全指数`, `健康指数`, and `当前可用电量`. All three should use the same large semicircle tick-gauge treatment as `安全诊断 / 全站当前 SOS 安全指数`, with consistent title, graphic, and value proportions.
