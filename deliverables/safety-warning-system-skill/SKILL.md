...
- For multi-row subsystem grids, keep bundle lines visible in the row gaps and avoid card occlusion. The top-left bundle convergence should look like a multi-vertical-line bus.
...
- In `安全预警 / 安全评估`, keep the `场站风险等级占比` donut at a readable medium size and true-circle aspect ratio.
