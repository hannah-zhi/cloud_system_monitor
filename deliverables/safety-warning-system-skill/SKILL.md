...
- The subsystem detail device topology should use independent SVG files from `assets/topology-icons/` for transformer/HV box, PCS, battery group, Rack, and Pack icons. Do not draw these device icons with CSS-only pseudo-elements.
