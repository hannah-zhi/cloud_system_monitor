...
- Replace the former `储能系统` top card with `充放电统计`. Provide `当日 / 当月 / 当年` time-window buttons at the top right, default to `当日`, and use two circular water-wave visuals for charge energy and discharge energy.
