...
- 预警详情:
  ...
  - Keep the warning-management donut chart and legend group visually centered. Legend labels and numbers should use compact spacing and must not be clipped.
